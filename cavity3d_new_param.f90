...
!*********************************************************************
    ...
    do l=1,pdm
      ...
      do k = g_kmin, g_kmax
      do j = g_jmin, g_jmax
        if( (i-id)>g_imin .and. (i-id)<g_imax .and. &
            (j-jd)>g_jmin .and. (j-jd)<g_jmax .and. &
            (k-kd)>g_kmin .and. (k-kd)<g_kmax )then
          f(i,j,k,m) = 0.5d0*( f(i-id,j-jd,k-kd,l) + f(i-id,j-jd,k-kd,m) )
        endif
      enddo; enddo
      i = g_imax
      do k = g_kmin, g_kmax
...
!***********************************************************
 ...
 !*********************************************************************
   ...
   do k = g_kmin, g_kmin
   do j = g_jmin+1, g_jmax
   do i = g_imin+1, g_imax-1
   !> floor
      f(i,j,k,5)  = f(i,j,k,6)
      f(i,j,k,9)  = f(i,j,k,11)
      f(i,j,k,10) = f(i,j,k,12)
      f(i,j,k,7)  = f(i,j,k,13)
      f(i,j,k,8)  = f(i,j,k,14)
   enddo
   enddo
   enddo
   ...
   !> wall(right)
      f(i,j,k,3)  = f(i,j,k,1)
      f(i,j,k,13) = f(i,j,k,7)
      f(i,j,k,9)  = f(i,j,k,11)
      f(i,j,k,12) = f(i,j,k,10)
      f(i,j,k,8)  = f(i,j,k,14)
   enddo; enddo
   ...
   !> wall(left)
      f(i,j,k,1)  = f(i,j,k,3)
      f(i,j,k,14) = f(i,j,k,8)
      f(i,j,k,11) = f(i,j,k,9)
      f(i,j,k,10) = f(i,j,k,12)
      f(i,j,k,7)  = f(i,j,k,13)
   enddo
   enddo
   ...
   !> front under edge 
      ...
      f(i,j,k,8)  = f(i,j,k,14)
      f(i,j,k,7)  = f(i,j,k,13)
      f(i,j,k,9)  = f(i,j,k,13)
      f(i,j,k,10) = f(i,j,k,13)
      f(i,j,k,12) = f(i,j,k,13)
      f(i,j,k,11) = f(i,j,k,13)
   enddo
   enddo
   enddo
   ...
   !> front top edge 
      ...
      f(i,j,k,11) = f(i,j,k,9)
      f(i,j,k,8)  = f(i,j,k,9)
      f(i,j,k,14) = f(i,j,k,9)
      f(i,j,k,7)  = f(i,j,k,9)
      f(i,j,k,13) = f(i,j,k,9)
   enddo
   enddo
   enddo
   ...
   !> front right edge 
      ...
      f(i,j,k,13) = f(i,j,k,10)
      f(i,j,k,11) = f(i,j,k,10)
   enddo
   enddo
   enddo
   ...
   !> side edge (right top) 
      ...
      f(i,j,k,13) = f(i,j,k,7)
      f(i,j,k,8)  = f(i,j,k,7)
      f(i,j,k,14) = f(i,j,k,7)
      f(i,j,k,9)  = f(i,j,k,7)
      f(i,j,k,11) = f(i,j,k,7)
   enddo
   enddo
   enddo
   ...
   do k = g_kmin, g_kmin
   do j = g_jmin+1, g_jmax
   !> side edge (right under) 
      f(i,j,k,5)  = f(i,j,k,6)
      f(i,j,k,3)  = f(i,j,k,1)
      f(i,j,k,9)  = f(i,j,k,11)
      f(i,j,k,8)  = f(i,j,k,14)
      f(i,j,k,10) = f(i,j,k,14)
      f(i,j,k,12) = f(i,j,k,14)
      f(i,j,k,7)  = f(i,j,k,14)
   ...
   do k = g_kmin, g_kmin
   do j = g_jmin+1, g_jmax
   !> side edge (left under) 
      f(i,j,k,5)  = f(i,j,k,6)
      f(i,j,k,1)  = f(i,j,k,3)
      f(i,j,k,7)  = f(i,j,k,13)
      f(i,j,k,10) = f(i,j,k,12)
      f(i,j,k,8)  = f(i,j,k,12)
      f(i,j,k,14) = f(i,j,k,12)
      f(i,j,k,9)  = f(i,j,k,12)
   ...
   !> right top corner 
      ...
      f(i,j,k,12) = f(i,j,k,10)
      f(i,j,k,7)  = f(i,j,k,10)
      f(i,j,k,8)  = f(i,j,k,10)
      f(i,j,k,9)  = f(i,j,k,10)
      f(i,j,k,11) = f(i,j,k,10)
      f(i,j,k,13) = f(i,j,k,10)
      f(i,j,k,14) = f(i,j,k,10)
   enddo
   enddo
   enddo
   ...
   !> left under corner 
      ...
      f(i,j,k,12) = f(i,j,k,13)
      f(i,j,k,7)  = f(i,j,k,13)
      f(i,j,k,8)  = f(i,j,k,13)
      f(i,j,k,14) = f(i,j,k,13)
      f(i,j,k,11) = f(i,j,k,13)
      f(i,j,k,9)  = f(i,j,k,13)
      f(i,j,k,10) = f(i,j,k,13)
   ...
   do i = g_imin,g_imax
      ...
      f(i,j,k,0:pdm) = equi_(q(i,j,k,1:5))
   enddo; enddo
   !call equilibrium(g_imin,g_imax,g_jmax,g_jmax,g_kmin,g_kmax,f)
